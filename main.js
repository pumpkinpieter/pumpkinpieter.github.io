...
import positions from './base_vertices_new.json';
import guideds from './guided_heights.json'
import propagatings from './propagating_heights.json'
import evanescents from './evanescent_heights.json'
import indices from './trig_indices_new.json';
import f0s from './f0s.json';
import x0s from './x0s.json';
